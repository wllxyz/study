...
static const int ERROR_TRACE_LEVEL=10;
static const int WARNING_TRACE_LEVEL=20;
static const int ERROR_TRACE=0;

static const int WARNING_TRACE=10;
static const int INFO_TRACE=20;
...
public:
 bool is_show;   //control all show or not
 bool is_info_show;  //control info show or not  (is_show && is_info_show)
 bool is_warning_show;  //control warning show or not (is_show && is_warning_show)
 bool is_error_show;  //control error show or not (is_show && is_error_show)
...
public:
 ...
 bool IsErrorShow(int mask) const;

 bool IsWarningShow(int mask) const;

 bool IsInfoShow(int mask) const;
